      ...
      <div className="container-narrow">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link href="/" className="font-serif font-bold text-lg hover:text-red-600 dark:hover:text-red-400 transition">
              LiloMelawan
            </Link>
          </div>
          ...
          <div className="flex space-x-4">
            <a 
              href="https://twitter.com/lilomelawan" 
              target="_blank" 
            ...
            <a 
              href="https://github.com/lilomelawan" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition"
              aria-label="GitHub"
            ...
            <a 
              href="https://instagram.com/lilomelawan" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition"
